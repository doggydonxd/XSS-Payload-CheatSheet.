...
[![GitHub Repo Size](https://img.shields.io/github/repo-size/doggydonxd/XSS-Payload-CheatSheet)](https://github.com/doggydonxd/XSS-Payload-CheatSheet)
[![GitHub Last Commit](https://img.shields.io/github/last-commit/doggydonxd/XSS-Payload-CheatSheet)](https://github.com/doggydonxd/XSS-Payload-CheatSheet/commits/main)
[![GitHub License](https://img.shields.io/github/license/doggydonxd/XSS-Payload-CheatSheet)](LICENSE)

**Disclaimer:**  
These payloads are provided **solely for educational and authorized penetration testing purposes**. Unauthorized or malicious use may be illegal and unethical. Always obtain explicit permission before testing any systems.


## Introduction

Cross-Site Scripting (XSS) allows attackers to inject malicious scripts into trusted websites, leading to various security risks. This cheat sheet consolidates up-to-date XSS payloads that cover different injection types, filtering evasion techniques, and practical use cases for security testing and automation.
...
<!-      Author : Zahidul Islam Ratul
<!-      Linkedin : https://www.linkedin.com/in/zahidul-islam-ratul/
<!-        GitHub : https://github.com/doggydonxd
<!-       Twitter : https://x.com/lolyratul025
<!-        Medium : https://medium.com/@halalbusinesse123
